...
const CONTRACT_LOCATION: &str = "contracts/l2-angstrom/";
const OUT_DIRECTORY: &str = "contracts/abis/";
const SRC_DIRECTORY: &str = "contracts/l2-angstrom/src";
const BINDINGS_PATH: &str = "/src/types/contracts/angstrom_l2.rs";

const WANTED_CONTRACTS: [&str; 2] = ["AngstromL2.sol", "AngstromL2Factory.sol"];
...
fn main() {
    ...
    println!("cargo::rerun-if-changed={CONTRACT_LOCATION}");
...
"#
    ...
    let out_path = format!("{this_dir}/sdk{BINDINGS_PATH}");
